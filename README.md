This github repository contains the data files and analysis code used in **"Multi-omic machine learning predictor of breast cancer therapy response"** published in _Nature_: 
